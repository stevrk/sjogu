...
<section class="relative bg-white border-b border-gray-200 py-16">
    <div class="container mx-auto px-4 md:px-16 text-center">
        ...
        <h1 class="text-3xl md:text-4xl font-bold text-gray-800 mb-2">Resources & <span class="text-red-600">Downloads</span></h1>
...
<section class="py-16 px-4 md:px-16 bg-gray-50">
    <div class="container mx-auto">
        ...
        <!-- Help Section -->
        <div class="mt-12 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 text-center border border-gray-200">
            <i class="fas fa-question-circle text-3xl text-gray-700 mb-3"></i>
