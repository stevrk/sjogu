            ...
            <div class="md:col-span-7 flex flex-col justify-between">
                <div>
                    <div class="mb-5 text-center md:text-left">
                        ...
                        <div class="flex items-center justify-center md:justify-start gap-3 mt-1 flex-wrap">
                    ...
                    <div class="space-y-3 text-gray-600 leading-relaxed text-[15px] text-center md:text-left">
                        ...
                        <div class="flex justify-center md:justify-start">
                            <p class="italic text-gray-700 border-l-2 border-red-600 pl-3 max-w-lg">
                ...
                <div>
                    <div class="mt-6 flex flex-wrap gap-3 justify-center md:justify-start">
                        <a href="#history" class="bg-red-600 text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-red-700 transition flex items-center gap-2 shadow-md">
                            Learn More <i class="fas fa-arrow-right text-xs"></i>
                        </a>
                        <a href="{{ route('enroll') }}" class="border-2 border-red-600 text-red-600 px-5 py-2.5 rounded-xl font-semibold hover:bg-red-600 hover:text-white transition flex items-center gap-2">
