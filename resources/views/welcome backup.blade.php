...
<body>
        ...
        <div class="p-6">
            ...
            <div class="mb-6 pb-6 border-b">
                <div class="flex gap-4">
                    ...
                    <!--<a href="#" class="flex-1 bg-red-50 text-red-700 py-2 rounded-lg text-center font-medium hover:bg-red-700 hover:text-white transition">
                        <i class="fas fa-chalkboard-user mr-2"></i>Staff
                    </a>-->
                </div>
            </div>
            
            <ul class="space-y-4">
                <li><a href="#" class="block py-2 text-gray-800 hover:text-red-700">Home</a></li>
                <li><a href="#about" class="block py-2 text-gray-800 hover:text-red-700">About</a></li>
                <li><a href="#programs" class="block py-2 text-gray-800 hover:text-red-700">Programs</a></li>
                
                <li>
                    <div class="block py-2 text-gray-800 font-medium">Media</div>
                    <div class="pl-4 mt-2 space-y-2 border-l-2 border-red-200">
                        <a href="#" class="block py-1 text-gray-600 hover:text-red-700">News</a>
                        <a href="#" class="block py-1 text-gray-600 hover:text-red-700">Announcements</a>
                        <a href="#" class="block py-1 text-gray-600 hover:text-red-700">Vacancies</a>
                        <a href="#" class="block py-1 text-gray-600 hover:text-red-700">Documents</a>
                    </div>
                </li>
                <li><a href="#" class="block py-2 text-gray-800 hover:text-red-700">Contact</a></li>
            </ul>
            <button class="mt-6 bg-red-700 text-white w-full py-2 rounded">Enroll Now</button>
        </div>
    </div>
    ...
    <div class="bg-red-700 text-white text-sm py-2 px-4 md:px-6 hidden md:flex flex-col md:flex-row justify-between items-center gap-2">
        ...
        <div class="flex items-center gap-4">
            <!-- Student & Staff Login Links - Hidden on mobile, visible on medium screens and up -->
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="#" class="hover:text-gray-200 transition flex items-center gap-1">
  ...
  <nav class="bg-white px-4 md:px-6 py-4 flex justify-between items-center shadow">
    <div class="flex items-center gap-3">
        ...
        <!--<h1 class="text-xl md:text-2xl font-bold">St John Of God University</h1>-->
    ...
    <div class="flex items-center gap-4">
        <ul class="hidden md:flex gap-8 font-medium">
            ...
            <li><a href="#about" class="hover:text-red-600 transition">About</a></li>
            <li><a href="#programs" class="hover:text-red-600 transition">Programs</a></li>
...
<section class="relative">
  ...
  <div class="absolute left-3 right-3 md:left-10 md:right-auto bottom-3 md:bottom-10 bg-white text-gray-800 p-3 md:p-10 w-auto md:w-[450px] shadow-xl rounded-lg md:rounded-none">
    ...
    <div class="flex flex-row gap-2 md:gap-3">
        <button class="bg-red-600 text-white px-2 md:px-6 py-1 md:py-2 rounded font-medium hover:bg-red-700 transition text-xs md:text-base flex-1 md:flex-none">
            See All Programs →
        </button>
       <a href="#Enroll" class="inline-block bg-gray-800 hover:bg-gray-900 text-white px-2 md:px-6 py-1 md:py-2 rounded font-medium transition border border-gray-300 text-xs md:text-base text-center">
    ENROLL NOW
    </a>
    </div>
</div>
...
<div id="modal1" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/clinical_medicine.jpg') }}" alt="Clinical Medicine" class="w-full h-64 object-cover rounded-lg mb-4">
...
<div id="modal2" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/nursing_midwifery.jpg') }}" alt="Nursing and Midwifery" class="w-full h-64 object-cover rounded-lg mb-4">
            <h4 class="font-semibold text-gray-800 mb-2">Program Overview</h4>
...
<div id="modal3" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/mental_health.jpg') }}" alt="Mental Health" class="w-full h-64 object-cover rounded-lg mb-4">
            <h4 class="font-semibold text-gray-800 mb-2">Program Overview</h4>
...
<div id="modal4" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/psychiatric_nursing.jpg') }}" alt="Psychiatric Nursing" class="w-full h-64 object-cover rounded-lg mb-4">
            <h4 class="font-semibold text-gray-800 mb-2">Program Overview</h4>
...
<div id="modal5" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/certificate_nursing.jpg') }}" alt="Certificate Nursing" class="w-full h-64 object-cover rounded-lg mb-4">
            <h4 class="font-semibold text-gray-800 mb-2">Program Overview</h4>
...
<div id="modal6" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 p-4">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="p-6">
            <img src="{{ asset('images/public_health.jpg') }}" alt="Public Health" class="w-full h-64 object-cover rounded-lg mb-4">
            <h4 class="font-semibold text-gray-800 mb-2">Program Overview</h4>
        ...
        <div class="grid md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition">
                ...
                <div class="p-6">
                    ...
                    <button class="w-full bg-red-600 text-white py-3 rounded-lg font-semibold hover:bg-red-700 transition flex items-center justify-center gap-2">
                ...
                <div class="p-6">
                    ...
                    <ul class="text-sm text-gray-600 mb-6 space-y-2">
                        <li class="flex items-center gap-2">
                            ...
                            <span>Undergraduate Application Form</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <i class="fas fa-file-pdf text-red-500 text-xs"></i>
                            <span>Postgraduate Application Form</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <i class="fas fa-file-pdf text-red-500 text-xs"></i>
                            <span>International Student Form</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <i class="fas fa-file-pdf text-red-500 text-xs"></i>
                    ...
                    <div class="flex gap-3">
                        <button class="flex-1 bg-gray-800 text-white py-2 rounded-lg font-semibold hover:bg-gray-900 transition flex items-center justify-center gap-2 text-sm">
                            <i class="fas fa-download"></i> Download All
                        </button>
                        <button class="flex-1 bg-red-600 text-white py-2 rounded-lg font-semibold hover:bg-red-700 transition flex items-center justify-center gap-2 text-sm">
