    ...
    <div class="flex">
        <div class="hidden lg:block w-72 bg-white min-h-screen shadow-lg">
            ...
            <div class="absolute bottom-0 w-72 p-4 border-t">
                <a href="/student-login" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-red-50 transition font-medium"><span class="text-xl">🚪</span> Logout</a>
            </div>
        </div>
