...
<body class="bg-gray-100">
    ...
    <div id="mobileMenu" class="mobile-menu shadow-lg">
        ...
        <nav class="p-4">
            <ul class="space-y-1">
                ...
                <li><a href="/portal/profile" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-red-600 text-white"><span class="text-lg">👤</span> Profile</a></li>
            </ul>
        </nav>
    ...
    <div class="flex">
        <div class="hidden lg:block w-72 bg-white min-h-screen shadow-lg">
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    ...
                    <li><a href="/portal/profile" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-red-600 text-white font-medium"><span class="text-xl">👤</span> Profile</a></li>
                </ul>
            </nav>
        ...
        <div class="flex-1 p-4 sm:p-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">My Profile</h1>

            <div class="bg-white rounded-xl shadow">
                <div class="p-6 sm:p-8">
                    <div class="flex flex-col md:flex-row gap-8">
                        <div class="text-center">
                            <div class="w-28 h-28 bg-red-600 rounded-full flex items-center justify-center mx-auto">
                                <i class="fas fa-user-graduate text-5xl text-white"></i>
                            </div>
                            <button class="mt-3 text-sm text-red-600 hover:text-red-700 font-medium">Change Photo</button>
                        </div>

                        <div class="flex-1">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                <div><p class="text-xs text-gray-500 mb-1">Full Name</p><p class="font-medium text-gray-800">John Michael Doe</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Student ID</p><p class="font-medium text-gray-800">2024-001</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Email Address</p><p class="font-medium text-gray-800">john.doe@sjogu.edu</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Phone Number</p><p class="font-medium text-gray-800">+265 123 456 789</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Program</p><p class="font-medium text-gray-800">Bachelor of Science in Clinical Medicine</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Year of Study</p><p class="font-medium text-gray-800">Year 3</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Registration Number</p><p class="font-medium text-gray-800">REG/2024/CLM/001</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Enrollment Date</p><p class="font-medium text-gray-800">September 2021</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Date of Birth</p><p class="font-medium text-gray-800">January 15, 2000</p></div>
                                <div><p class="text-xs text-gray-500 mb-1">Nationality</p><p class="font-medium text-gray-800">Malawian</p></div>
                            </div>
                            <div class="mt-6 flex flex-wrap gap-3">
                                <button class="bg-red-600 text-white px-6 py-2.5 rounded-lg hover:bg-red-700 transition font-medium">Edit Profile</button>
                                <button class="border border-red-600 text-red-600 px-6 py-2.5 rounded-lg hover:bg-red-50 transition font-medium">Change Password</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mt-6 bg-gray-50 rounded-xl p-5 border border-gray-200">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    <div><h3 class="font-semibold text-gray-800">Need Help?</h3><p class="text-sm text-gray-600 mt-1">Contact the IT support desk for portal assistance</p></div>
                    <a href="#" class="text-red-600 font-medium hover:underline">Contact Support →</a>
                </div>
            </div>
        </div>
    </div>
