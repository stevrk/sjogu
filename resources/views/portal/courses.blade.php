...
<body class="bg-gray-100">
    ...
    <div id="mobileMenu" class="mobile-menu shadow-lg">
        ...
        <nav class="p-4">
            <ul class="space-y-1">
                ...
                <li><a href="/portal/courses" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-red-600 text-white"><span class="text-lg">📚</span> My Courses</a></li>
    ...
    <div class="flex">
        <div class="hidden lg:block w-72 bg-white min-h-screen shadow-lg">
            ...
            <nav class="p-4">
                <ul class="space-y-1">
                    ...
                    <li><a href="/portal/courses" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-red-600 text-white font-medium"><span class="text-xl">📚</span> My Courses</a></li>
        ...
        <div class="flex-1 p-4 sm:p-6">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mb-2">My Courses</h1>
            ...
            <div class="space-y-4">
                    ...
                    <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-12 h-12 bg-red-100 rounded-lg flex items-center justify-center"><i class="fas fa-stethoscope text-red-600 text-xl"></i></div>
                                <div><h3 class="text-lg font-bold text-gray-800">Clinical Medicine</h3><p class="text-gray-600 text-sm">CLM 401 - Dr. M. Banda</p></div>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-3 text-sm text-gray-500">
                                <span><i class="far fa-clock mr-1"></i> Mon & Wed | 8:00-10:00 AM</span>
                                <span><i class="fas fa-map-marker-alt mr-1"></i> Room 201, Med Block</span>
                                <span><i class="fas fa-credit-card mr-1"></i> 3 Credits</span>
                            </div>
                        </div>
                        <span class="bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold text-center whitespace-nowrap">In Progress</span>
                    </div>
                    <div class="mt-4 pt-3 border-t flex flex-wrap gap-3 text-sm">
                        <span class="text-gray-500">📊 Next Class: Today, 8:00 AM</span>
                        <span class="text-gray-500">📝 Assignment: Case Study Due April 20</span>
                        <span class="text-green-600">📈 Attendance: 92%</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow hover:shadow-lg transition p-5">
                    <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center"><i class="fas fa-hand-holding-heart text-blue-600 text-xl"></i></div>
                                <div><h3 class="text-lg font-bold text-gray-800">Nursing Practice</h3><p class="text-gray-600 text-sm">NUR 402 - Prof. J. Phiri</p></div>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-3 text-sm text-gray-500">
                                <span><i class="far fa-clock mr-1"></i> Tue & Thu | 10:00-12:00 PM</span>
                                <span><i class="fas fa-map-marker-alt mr-1"></i> Nursing Lab</span>
                                <span><i class="fas fa-credit-card mr-1"></i> 4 Credits</span>
                            </div>
                        </div>
                        <span class="bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold">In Progress</span>
                    </div>
                    <div class="mt-4 pt-3 border-t flex flex-wrap gap-3 text-sm">
                        <span class="text-gray-500">📊 Next Class: Tomorrow, 10:00 AM</span>
                        <span class="text-gray-500">📝 Assignment: Clinical Report Due April 18</span>
                        <span class="text-green-600">📈 Attendance: 94%</span>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow hover:shadow-lg transition p-5">
                    <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                ...
                                <div><h3 class="text-lg font-bold text-gray-800">Public Health</h3><p class="text-gray-600 text-sm">PUB 403 - Dr. L. Chibwana</p></div>
                            </div>
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-3 text-sm text-gray-500">
                                <span><i class="far fa-clock mr-1"></i> Friday | 2:00-5:00 PM</span>
                                <span><i class="fas fa-map-marker-alt mr-1"></i> Room 105, PH Block</span>
                                <span><i class="fas fa-credit-card mr-1"></i> 3 Credits</span>
                            </div>
                        </div>
                        <span class="bg-green-100 text-green-700 px-4 py-2 rounded-full text-sm font-semibold">In Progress</span>
                    ...
                    <div class="mt-4 pt-3 border-t flex flex-wrap gap-3 text-sm">
                        <span class="text-gray-500">📊 Next Class: Friday, 2:00 PM</span>
                        <span class="text-gray-500">📝 Assignment: Research Proposal Due April 25</span>
                        <span class="text-yellow-600">📈 Attendance: 88%</span>
                    </div>
                </div>
            </div>
        </div>
